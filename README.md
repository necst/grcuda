...
If you are installing GrCUDA on a new machine, you can simply follow or execute first `oci_setup/setup_machine_from_scratch.sh` and then `oci_setup/setup_graalvm.sh`. Here we repeat the same steps, with additional comments. 
The installation process has been validated with CUDA 11.7 and Ubuntu 20.04.
