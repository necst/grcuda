...
UNMODIFIED_CUBIN_NAME = "dot_product_checked.cubin"
UNMODIFIED_KERNEL_NAME = "dot_product_checked"
UNMODIFIED_KERNEL_FOLDER = "../../unmodified_kernel_cubin"
UNMODIFIED_KERNEL_PARAMS = "pointer, pointer, uint32, pointer"

MODIFIED_CUBIN_NAME = "dot_product.cubin"
MODIFIED_KERNEL_NAME = "dot_product"
...
def main(args):
    ...
    res = polyglot.eval(language='cuda', string='float[{}]'.format(1))
    ...
    res2 = polyglot.eval(language='cuda', string='float[{}]'.format(1))
    ...
    for i in range(num_test):
        ...
        if os.path.isfile(modified_kernel_path):
            exec_time, exec_time_k = run_kernel(debug, num_blocks, MODIFIED_KERNEL_NAME, modified_kernel_path, MODIFIED_KERNEL_PARAMS,
             [x2, y2, len(x2), res2], deduct_sizes=True)
