...
public class SparseMatrixCSCFunction extends Function{
    private final AbstractGrCUDAExecutionContext grCUDAExecutionContext;
    private final int NUM_ARGUMENTS = 6;
    private final int NUM_ARGUMENTS_NULL = 4; // number of expected arguments if creating empty matrix

    public SparseMatrixCSCFunction(AbstractGrCUDAExecutionContext grCUDAExecutionContext) {
        super("SparseMatrixCSC");
    ...
    public Object call(Object[] arguments) throws ArityException, UnsupportedTypeException {
        ...
        if (arguments.length == NUM_ARGUMENTS) {
            DeviceArray cscRowInd = (DeviceArray) arguments[0];
            DeviceArray cscColOffsets = (DeviceArray) arguments[1];
            ...
            return new SparseMatrixCSC(grCUDAExecutionContext, colIndices, cumulativeNnz, nnzValues,
